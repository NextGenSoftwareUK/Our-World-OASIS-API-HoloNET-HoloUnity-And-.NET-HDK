...
$("#loginForm").submit(function (event) {
	...
	$.ajax({
		...
		success() {
			console.log('Avatar authenticated')
		},
		error() {
			Swal.fire({
				title: 'Invalid Login',
	...
	// xhr.open("https://api.oasisplatform.world/api/avatar/authenticate/", true);
	// xhr.setRequestHeader("Content Type", "application/json");
	// xhr.onload = function () {
	// 	var response = JSON.parse(xrh.responseText);
	...
	// if (response.status === 200) {
	// jwtToken = response.avatar[0].jwtToken;
	// localStorage.setItem("token", response.data.jwtToken);
	// console.log(jwtToken);
	// close modal
	// } else if (response.status == 204) {
	// console.log("Username and password do not match");
	// sweetalert same message
	// } else {
	...
	// 	console.log("b4 = " + document.getElementById(Login").style.display);

	// 	document.getElementById(Login").style.display = "block";
	// 	document.getElementById(ForgotPassword").style.display = "none";
	// 	document.getElementById(NewAccount").style.display = "none";	

	// 	console.log("after = " + document.getElementById(Login").style.display);
	// };

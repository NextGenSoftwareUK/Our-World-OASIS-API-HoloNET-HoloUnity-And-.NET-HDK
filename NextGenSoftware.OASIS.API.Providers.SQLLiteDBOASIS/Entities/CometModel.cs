...
namespace NextGenSoftware.OASIS.API.Providers.SQLLiteDBOASIS.Entities{
    ...
    [Table("Comet")]
    public class CometModel : CelestialBodyAbstract{

        [Required, Key]
        public String CometId{ set; get; }
        ...
        public CometModel():base(){}
        public CometModel(IComet source):base(){

            if(source.Id == Guid.Empty){
                source.Id = Guid.NewGuid();
            }
        
            this.CometId = source.Id.ToString();
        ...
        public Comet GetComet()
        {
            ...
            item.Id = Guid.Parse(this.CometId);

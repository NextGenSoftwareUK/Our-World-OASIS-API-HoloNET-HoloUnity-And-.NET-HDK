			...
			*/
			...
			else
			{
				...
				$.post("https://oasisplatform.world/api/avatar/authenticate",
					{
						email: "david@nextgensoftware.co.uk",
				...
				xhttp.open("POST", "http://oasisplatform.world/api/avatar/authenticate", true);
				xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				xhttp.send("email=david@nextgensoftware.co.uk&password=new-super-secret-password");
				...
				*/
				...
				xhr.send("email=david@nextgensoftware.co.uk&password=new-super-secret-password");

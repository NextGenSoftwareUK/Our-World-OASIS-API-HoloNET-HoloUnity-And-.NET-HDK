...
namespace NextGenSoftware.OASIS.API.Core.Interfaces.STAR
{
    public interface ICelestialBodyCore : IZome
    {
        ...
        Task<OASISResult<IHolon>> LoadCelestialBodyAsync(bool loadChildren = true, bool recursive = true, bool continueOnError = true);
        OASISResult<IHolon> LoadCelestialBody(bool loadChildren = true, bool recursive = true, bool continueOnError = true);
        Task<OASISResult<ICelestialBody>> LoadCelestialBodyAsync<T>(bool loadChildren = true, bool recursive = true, bool continueOnError = true) where T : ICelestialBody, new();
        OASISResult<ICelestialBody> LoadCelestialBody<T>(bool loadChildren = true, bool recursive = true, bool continueOnError = true) where T : ICelestialBody, new();

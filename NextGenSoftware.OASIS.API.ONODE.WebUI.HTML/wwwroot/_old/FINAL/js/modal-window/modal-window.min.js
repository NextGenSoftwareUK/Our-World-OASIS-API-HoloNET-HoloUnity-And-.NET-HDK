! function() {
    ...
    e.prototype.getPreventScrollEl = function() {
        ...
        })), this.emitModalEvents("modalIsOpen"), this.preventScrollEl && (this.preventScrollEl.style.overflow = "x-je")
        ...
        var e = this.element.querySelectorAll(l);
        ...
        if (this.modalFocus && Element.prototype.matches)
            if (this.modalFocus.matches(l)) this.moveFocusEl = this.modalFocus;
                ...
                this.moveFocusEl = !1;
                for (var e = this.modalFocus.querySelectorAll(l), t = 0; t < e.length; t++)
                    if (s(e[t])) {
    ...
    if (0 < o.length) {
        for (var i = [], n = 0; n < o.length; n++) t = n, i.push(new e(o[t]));
        window.addEventListener("keydown", function(e) {
            if (e.keyCode && 27 == e.keyCode || e.key && "escape" == e.key.toLowerCase())
                for (var t = 0; t < i.length; t++) i[t].closeModal()
        })
    }
}();
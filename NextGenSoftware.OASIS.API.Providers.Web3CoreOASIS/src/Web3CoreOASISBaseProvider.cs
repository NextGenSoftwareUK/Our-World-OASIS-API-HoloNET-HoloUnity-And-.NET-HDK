    ...
    OASISStorageProviderBase, IOASISDBStorageProvider, IOASISNETProvider, IOASISSuperStar, IOASISBlockchainStorageProvider
{
    ...
    private readonly string _abi = abi;
    ...
    public override OASISResult<bool> ActivateProvider()
    {
        ...
        try
        {
            ...
            {
                _web3CoreOASIS = new(_chainPrivateKey, _hostURI, _contractAddress, _abi);
    ...
    private async Task<OASISResult<ITransactionRespone>> SendTransactionBaseAsync(string senderAccountPrivateKey, string receiverAccountAddress, decimal amount)
    {
        ...
        try
        {
            Web3CoreOASIS web3CoreInstance = new(senderAccountPrivateKey, _hostURI, _contractAddress, _abi);

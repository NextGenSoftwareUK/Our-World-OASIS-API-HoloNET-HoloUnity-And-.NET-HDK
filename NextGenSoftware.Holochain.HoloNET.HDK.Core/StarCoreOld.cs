...
//    public class StarCoreOld : CelestialBodyCore, IZome
//    {
...
//        public StarCoreOld(HoloNETClientBase holoNETClient, string providerKey) : base(holoNETClient, STAR_CORE_ZOME)
//        {
//            _providerKey = providerKey;
//        }

//        public StarCoreOld(string holochainConductorURI, HoloNETClientType type, string providerKey) : base(holochainConductorURI, STAR_CORE_ZOME, type)
//        {
//            _providerKey = providerKey;
//        }

//        public StarCoreOld(HoloNETClientBase holoNETClient) : base(holoNETClient, STAR_CORE_ZOME, STAR_HOLON_TYPE, STAR_HOLONS_TYPE)
//        {

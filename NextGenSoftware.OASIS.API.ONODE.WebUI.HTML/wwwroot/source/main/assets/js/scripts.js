...
(Util.hasClass = function (e, t) {
    ...
    (Util.scrollTo = function (n, s, i, e) {
        ...
        var r = function (e) {
            ...
            o.scrollTo(0, e),
                t < s ? window.requestAnimationFrame(r) : i && i();
        };
...
function onSignup() {
    let n = {
        ...
        confirmPassword: document.getElementById('confirm-signup-password')
            .value,
        acceptTerms: !0,
        avatarType: 'User',
    };
...
(Math.easeInOutQuad = function (e, t, n, s) {
    ...
    jQuery(document).ready(function (e) {
        function t(e) {
            (this.element = e),
                (this.blocks =
                    document.getElementsByClassName('js-modal-block')),
                (this.triggers =
                ...
                (e = n),
                    t.triggers[e].addEventListener('click', function (e) {
                        e.target.hasAttribute('data-signin') &&
                            (e.preventDefault(),
                            t.showSigninForm(
                                e.target.getAttribute('data-signin')
                            ));
                    });

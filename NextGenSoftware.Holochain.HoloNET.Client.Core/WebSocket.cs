  ...
  public class WebSocket : IWebSocket {
    ...
    public void DelegateOnCloseEvent (int closeCode) {
      this.OnClose?.Invoke (WebSocketHelpers.ParseCloseCodeEnum (closeCode));
        ...
        public class WebSocket2 : IWebSocket
        {
            public event WebSocketOpenEventHandler OnOpen;
            public event WebSocketMessageEventHandler OnMessage;
            public event WebSocketErrorEventHandler OnError;
            ...
            public WebSocket2(string url, Dictionary<string, string> headers = null)
            {
                uri = new Uri(url);
            ...
            public WebSocket2(string url, string subprotocol, Dictionary<string, string> headers = null)
            {
                uri = new Uri(url);
            ...
            public WebSocket2(string url, List<string> subprotocols, Dictionary<string, string> headers = null)
            {
                uri = new Uri(url);
    ...
    public static void DelegateOnCloseEvent (int instanceId, int closeCode) {
      ...
      if (instances.TryGetValue (instanceId, out instanceRef)) {
        instanceRef.DelegateOnCloseEvent (closeCode);
            ...
            public static WebSocket2 CreateInstance(string url)
            {

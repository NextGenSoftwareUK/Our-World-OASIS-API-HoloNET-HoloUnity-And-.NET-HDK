...
namespace NextGenSoftware.OASIS.API.Providers.SQLLiteDBOASIS.Entities{
    ...
    [Table("GrandSuperStar")]
    public class GrandSuperStarModel : StarModelBase{

        public GrandSuperStarModel():base(){}
        public GrandSuperStarModel(IGrandSuperStar source):base(){
        ...
        // public IGrandSuperStar GetGrandSuperStar(){
        //
        //     GrandSuperStar item=new GrandSuperStar();
        //

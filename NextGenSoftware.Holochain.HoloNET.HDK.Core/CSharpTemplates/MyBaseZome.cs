...
namespace NextGenSoftware.Holochain.HoloNET.HDK.Core.CSharpTemplates
{
    public partial class MyZome : HolochainBaseZome
    {
        ...
        public MyZome(HoloNETClientBase holoNETClient) : base(holoNETClient)
        {

        }

        public MyZome(string holochainConductorURI, HoloNETType type) : base(holochainConductorURI, type)
        {

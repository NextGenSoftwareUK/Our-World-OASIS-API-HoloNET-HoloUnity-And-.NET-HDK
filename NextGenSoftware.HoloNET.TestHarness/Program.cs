...
namespace NextGenSoftware.Holochain.HoloNET.Client.TestHarness
{
    class Program
    {
        ...
        {
            Console.WriteLine("NextGenSoftware.HOLONET Test Harness v1.1");
            Console.WriteLine("");
            ...
            holoNETClient.CallZomeFunctionAsync("1", "test-instance", "our_world_core", "test", ZomeCallback, new { message = new { content = "blah!" }});
            holoNETClient.CallZomeFunctionAsync("2", "test-instance", "our_world_core", "test2", ZomeCallback, new { message = "blah!" });

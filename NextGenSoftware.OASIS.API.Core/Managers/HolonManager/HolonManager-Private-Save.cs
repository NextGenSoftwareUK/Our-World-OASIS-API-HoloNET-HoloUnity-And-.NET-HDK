...
namespace NextGenSoftware.OASIS.API.Core.Managers
{
    public partial class HolonManager : OASISManager
    {
        ...
        private OASISResult<T> SaveHolonForProviderType<T>(IHolon holon, ProviderType providerType, OASISResult<T> result, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true)
        {
            try
            {
                HasHolonChanged(holon, ref result);
        ...
        private async Task<OASISResult<T>> SaveHolonForProviderTypeAsync<T>(T holon, ProviderType providerType, OASISResult<T> result, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true) where T : IHolon
        {
            try
            {
        ...
        private OASISResult<IEnumerable<T>> SaveHolonsForProviderType<T>(IEnumerable<T> holons, ProviderType providerType, OASISResult<IEnumerable<T>> result, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true)
        {
            try
            {
                HasAnyHolonsChanged(holons, ref result);
                ...
                else if (result != null)
                {
                    ...
                    OASISResult<IEnumerable<IHolon>> saveHolonsResult = providerResult.Result.SaveHolons(holonsToSave, saveChildren, recursive, maxChildDepth, 0, continueOnError);
        ...
        private async Task<OASISResult<IEnumerable<T>>> SaveHolonsForProviderTypeAsync<T>(IEnumerable<T> holons, ProviderType providerType, OASISResult<IEnumerable<T>> result, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true)
        {
            try
            {
                HasAnyHolonsChanged(holons, ref result);
                ...
                else if (result != null)
                {
                    ...
                    OASISResult<IEnumerable<IHolon>> saveHolonsResult = await providerResult.Result.SaveHolonsAsync(holonsToSave, saveChildren, recursive, maxChildDepth, 0, continueOnError);
        ...
        private async Task<OASISResult<T>> SaveHolonForListOfProvidersAsync<T>(T holon, OASISResult<T> result, ProviderType currentProviderType, List<EnumValue<ProviderType>> providers, string listName, bool continueOSuccess, bool saveChildren = true, bool recursive = true, int maxChildDepth = 0, bool continueOnError = true) where T : IHolon
        {
            OASISResult<T> holonSaveResult = new OASISResult<T>();
            ProviderType originalCurrentProvider = ProviderManager.Instance.CurrentStorageProviderType.Value;

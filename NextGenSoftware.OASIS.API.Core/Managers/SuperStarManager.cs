...
namespace NextGenSoftware.OASIS.API.Core
{
    public class SuperStarManager : OASISManager
    {
        ...
        public bool NativeCodeGenesis(ProviderType provider = ProviderType.Default)
        {
            return ((IOASISSuperStar)ProviderManager.SetAndActivateCurrentStorageProvider(provider)).NativeCodeGenesis();
        }

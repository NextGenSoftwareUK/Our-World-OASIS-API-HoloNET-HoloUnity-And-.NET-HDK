...
namespace NextGenSoftware.OASIS.STAR.CelestialSpace
{
    public class OmniverseDimension : Dimension, IOmniverseDimension
    {
        ...
        public OmniverseDimension(string providerKey, ProviderType providerType, IOmiverse omniverse = null) : base(providerKey, providerType)
        {
            Init(omniverse);
        }
        ...
        private void Init(IOmiverse omniverse = null)
        {
            ...
            base.AddCelestialSpace(SuperVerse, false);
        }
    }
}
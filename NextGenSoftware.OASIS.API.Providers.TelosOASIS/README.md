# NextGen Software WEB4 OASIS API Telos OASIS Provider

WEB4 OASIS API Telos OASIS Provider is one of the many WEB2/WEB3 providers that plug in and integtate into the OASIS.

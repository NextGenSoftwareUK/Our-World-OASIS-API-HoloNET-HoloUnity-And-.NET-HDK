...
namespace NextGenSoftware.OASIS.STAR
{
    ...
    public class GreatGrandSuperStarCore : CelestialBodyCore<Star>, IGreatGrandSuperStarCore
    {
        ...
        public async Task<OASISResult<IOmiverse>> AddOmiverseAsync(IOmiverse omniverse)
        {
            ...
            OASISResult<IHolon> holonResult = await SaveHolonAsync(omniverse, false);
        ...
        public async Task<OASISResult<IEnumerable<IMultiverse>>> GetAllMultiversesForOmiverseAsync(bool refresh = true)
        {
            ...
            OASISResultHelper<IEnumerable<IHolon>, IEnumerable<IMultiverse>>.CopyResult(holonResult, result);
        ...
        public async Task<OASISResult<IEnumerable<IUniverse>>> GetAllUniversesForOmiverseAsync(bool refresh = true)
        {
            OASISResult<IEnumerable<IUniverse>> result = new OASISResult<IEnumerable<IUniverse>>();
            OASISResult<IEnumerable<IMultiverse>> multiversesResult = await GetAllMultiversesForOmiverseAsync(refresh);
            OASISResultHelper<IEnumerable<IMultiverse>, IEnumerable<IUniverse>>.CopyResult(multiversesResult, result);
        ...
        public async Task<OASISResult<IEnumerable<IDimension>>> GetAllDimensionsForOmiverseAsync(bool refresh = true)
        {
            ...
            OASISResultHelper<IEnumerable<IMultiverse>, IEnumerable<IDimension>>.CopyResult(multiveresesResult, result);
        ...
        public async Task<OASISResult<IEnumerable<IGrandSuperStar>>> GetAllGrandSuperStarsForOmiverseAsync(bool refresh = true)
        {
            ...
            OASISResult<IEnumerable<IMultiverse>> multiversesResult = await GetAllMultiversesForOmiverseAsync(refresh);
            OASISResultHelper<IEnumerable<IMultiverse>, IEnumerable<IGrandSuperStar>>.CopyResult(multiversesResult, result);
        ...
        public async Task<OASISResult<IEnumerable<ISuperStar>>> GetAllSuperStarsForOmiverseAsync(bool refresh = true)
        {
            ...
            OASISResultHelper<IEnumerable<IGrandSuperStar>, IEnumerable<ISuperStar>>.CopyResult(grandSuperStarsResult, result);

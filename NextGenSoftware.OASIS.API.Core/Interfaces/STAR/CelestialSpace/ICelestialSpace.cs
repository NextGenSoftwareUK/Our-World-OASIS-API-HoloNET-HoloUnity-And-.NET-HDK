...
namespace NextGenSoftware.OASIS.API.Core.Interfaces.STAR
{
    public interface ICelestialSpace : ICelestialHolon
    {
        ...
        Task<OASISResult<ICelestialSpace>> SaveAsync(bool saveChildren = true, bool continueOnError = true);
        OASISResult<ICelestialSpace> Save(bool saveChildren = true, bool continueOnError = true);
    }
}
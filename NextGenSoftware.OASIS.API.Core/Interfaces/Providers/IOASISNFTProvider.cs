...
namespace NextGenSoftware.OASIS.API.Core.Interfaces
{
    public interface IOASISNFTProvider : IOASISProvider
    {
        ...
        public OASISResult<INFTTransactionRespone> SendNFT(INFTWalletTransaction transation);
        public Task<OASISResult<INFTTransactionRespone>> SendNFTAsync(INFTWalletTransaction transation);

        public OASISResult<INFTTransactionRespone> MintNFT(IMintNFTTransaction transation);
        public Task<OASISResult<INFTTransactionRespone>> MintNFTAsync(IMintNFTTransaction transation);

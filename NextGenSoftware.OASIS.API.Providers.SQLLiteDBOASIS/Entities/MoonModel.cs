...
namespace NextGenSoftware.OASIS.API.Providers.SQLLiteDBOASIS.Entities{
    ...
    [Table("Moon")]
    public class MoonModel : CelestialBodyAbstract{

        [Required, Key]
        public String MoonId{ set; get; }
        public String ParentPlanetId{set;get;}

        public MoonModel():base(){}
        public MoonModel(IMoon source):base(){

            if(source.Id == Guid.Empty){
                source.Id = Guid.NewGuid();
            }
        
            this.MoonId = source.Id.ToString();
        ...
        // public IMoon GetMoon(){
        //     Moon item=new Moon();
        //
        //     item.Id = Guid.Parse(this.MoonId);

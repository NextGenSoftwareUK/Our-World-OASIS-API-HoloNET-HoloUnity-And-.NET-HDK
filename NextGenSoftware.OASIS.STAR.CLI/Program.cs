...
namespace NextGenSoftware.OASIS.STAR.CLI
{
    class Program
    {
        ...
        private static void ShowCommands()
        {
            ...
            Console.WriteLine("   star listoapps {searchAll} - List all OAPPs (contains zomes and holons) that have been generated. If {searchAll} is omitted it will list only your OAPP's otherwise it will list all published OAPP's as well as your OAPP's.");
            Console.WriteLine("   star listinstalledoapps - List all OAPP's installed for the current beamed in avatar.");
            Console.WriteLine("   star listhapps {searchAll} - List all hApps (contains zomes) that have been generated. If {searchAll} is omitted it will list only your hApp's otherwise it will list all published hApp's as well as your celestial hApp's.");
            Console.WriteLine("   star listinstalledhapps - List all hApp's installed for the current beamed in avatar.");
            Console.WriteLine("   star listzomes {searchAll} - List all zomes (modules that contain holons) that have been generated. If {searchAll} is omitted it will list only your zomes otherwise it will list all published hApp's as well as your zomes.");
            Console.WriteLine("   star listholons {searchAll} - List all holons (OASIS Data Objects) that have been generated. If {searchAll} is omitted it will list only your holons otherwise it will list all published holons as well as your holons.");
            Console.WriteLine("   star listcelestialbodies {searchAll} - List all celestial bodies that have been generated. If {searchAll} is omitted it will list only your celestial bodies otherwise it will list all published celestial bodies as well as your celestial bodies.");
            Console.WriteLine("   star listcelestialspaces {searchAll} - List all celestial spaces that have been generated. If {searchAll} is omitted it will list only your celestial spaces otherwise it will list all published celestial spaces as well as your celestial spaces.");
            ...
            Console.WriteLine("   star listgeonfts {searchAll} - List all geo-nft's that have been created. If {searchAll} is omitted it will list only your geo-nft's otherwise it will list all published geo-nft's as well as your geo-nft's.");
            ...
            Console.WriteLine("   star createinventoryitem = Creates an inventory item that can be granted as a reward (will be placed in the avatar's inventory) for completing quests, collecting geo-nft's, triggering geo-hotspots etc.");
            Console.WriteLine("   star updateinventoryitem = Updates an inventory item.");
            Console.WriteLine("   star deleteinventoryitem = Deletes an inventory item.");
            Console.WriteLine("   star publishinventoryitem = Publishes an inventory item to the STARNET store so others can use in their own quests, geo-hotspots, geo-nfts, etc.");
            Console.WriteLine("   star unpublishinventoryitem = Unpublishes an inventory item from the STARNET store.");
            //Console.WriteLine("   star activateinventoryitem = Activates an inventory item that has been published to the STARNET store so is visible to others.");
            //Console.WriteLine("   star deactivateinventoryitem = Deactivates an inventory item that has been published to the STARNET store so is invisible to others.");
            Console.WriteLine("   star creategeohotspot = Creates a geo-hotspot that chapters & quests can be added to.");
            Console.WriteLine("   star updategeohotspot = Updates a geo-hotspot.");
            Console.WriteLine("   star deletegeohotspot = Deletes an geo-hotspot.");
            Console.WriteLine("   star publishgeohotspot = Publishes a geo-hotspot to the STARNET store so others can use in their own quests.");
            Console.WriteLine("   star unpublishgeohotspot = Unpublishes a geo-hotspot from the STARNET store.");
            Console.WriteLine("   star listgeohotspots {searchAll} - List all geo-hotspot's that have been created. If {searchAll} is omitted it will list only your geo-hotspot's otherwise it will list all published geo-hotspot's as well as your geo-hotspot's.");
            Console.WriteLine("   star createmission = Creates a mission that chapters & quests can be added to.");
            Console.WriteLine("   star updatemission = Updates a mission.");
            Console.WriteLine("   star deletemission = Deletes an mission.");
            Console.WriteLine("   star publishmission = Publishes a mission to the STARNET store so others can find and play in Our World/AR World, One World & any other OASIS OAPP.");
            Console.WriteLine("   star unpublishmission = Unpublishes a mission from the STARNET store.");
            Console.WriteLine("   star listmissions {searchAll} - List all mission's that have been created. If {searchAll} is omitted it will list only your mission's otherwise it will list all published mission's as well as your mission's.");
            Console.WriteLine("   star createquest = Creates a quest that can be linked to a mission. Geo-nfts, geo-hotspots & rewards can be linked to the quest.");
            Console.WriteLine("   star updatequest = Updates a quest.");
            Console.WriteLine("   star deletequest = Deletes a quest.");
            Console.WriteLine("   star publishquest = Publishes a quest to the STARNET store so others can use in their own quests as sub-quests or in missions/chapters.");
            Console.WriteLine("   star unpublishquest = Unpublishes a quest from the STARNET store.");
            Console.WriteLine("   star listquests {searchAll} - List all quests that have been created. If {searchAll} is omitted it will list only your quests otherwise it will list all published quests as well quests.");
            Console.WriteLine("   star createchapter = Creates a chapter that can be linked to a mission. Quests can be added to the chapter. Chapters are used to group quests together (optional).");
            Console.WriteLine("   star updatechapter = Updates a chapter.");
            Console.WriteLine("   star deletechapter = Deletes a chapter.");
            Console.WriteLine("   star publishchapter = Publishes a chapter to the STARNET store so others can use in their own missions.");
            Console.WriteLine("   star unpublishchapter = Unpublishes a chapter from the STARNET store.");
            Console.WriteLine("   star listchapters {searchAll} - List chapters that have been created. If {searchAll} is omitted it will list only your chapters otherwise it will list all published chapters as well as your chapters.");

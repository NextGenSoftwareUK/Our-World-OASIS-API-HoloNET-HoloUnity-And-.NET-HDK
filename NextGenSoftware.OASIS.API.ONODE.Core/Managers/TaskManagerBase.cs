...
//        public async Task<OASISResult<IQuest>> CreateTaskAsync(string name, string description, Guid avatarId, Guid missionId, ProviderType providerType = ProviderType.Default)
//        {
//            OASISResult<IQuest> result = new OASISResult<IQuest>();
//            string errorMessage = "Error occured in TaskManagerBase.CreateTaskAsync. Reason:";

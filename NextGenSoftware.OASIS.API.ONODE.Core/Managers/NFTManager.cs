    ...
    public class NFTManager : OASISManager, INFTManager
    {
       ...
       // public Guid AvatarId { get; set; }
        ...
        public async Task<OASISResult<IEnumerable<IOASISGeoSpatialNFT>>> LoadAllGeoNFTsForAvatarAsync(Guid avatarId, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                result = DecodeGeoNFTMetaData(await Data.LoadHolonsForParentByMetaDataAsync("GEONFT.PlacedByAvatarId", avatarId.ToString(), HolonType.GEONFT, true, true, 0, true, 0, providerType), result, errorMessage);
            }
            catch (Exception e)
            {
                OASISErrorHandling.HandleError(ref result, $"{errorMessage} Unknown error occured: {e.Message}", e);
        ...
        public async Task<OASISResult<IEnumerable<IOASISGeoSpatialNFT>>> LoadAllGeoNFTsForMintAddressAsync(string mintWalletAddress, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                result = DecodeGeoNFTMetaData(await Data.LoadHolonsForParentByMetaDataAsync("GEONFT.OriginalOASISNFT.MintWalletAddress", mintWalletAddress, HolonType.GEONFT, true, true, 0, true, 0, providerType), result, errorMessage);
            }
            catch (Exception e)
            {
                OASISErrorHandling.HandleError(ref result, $"{errorMessage} Unknown error occured: {e.Message}", e);
        ...
        public OASISResult<IEnumerable<IOASISGeoSpatialNFT>> LoadAllGeoNFTsForMintAddress(string mintWalletAddress, ProviderType providerType = ProviderType.Default)
        {
            ...
            try
            {
                result = DecodeGeoNFTMetaData(Data.LoadHolonsForParentByMetaData("GEONFT.OriginalOASISNFT.MintWalletAddress", mintWalletAddress, HolonType.GEONFT, true, true, 0, true, 0, providerType), result, errorMessage);
            }
            catch (Exception e)
            {
                OASISErrorHandling.HandleError(ref result, $"{errorMessage} Unknown error occured: {e.Message}", e);
